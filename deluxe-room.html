<!DOCTYPE html>
<html><head>
    <title>Deluxe Room | Amadi Beach Front Resort</title>
    <meta name="keywords" conDeluxe Room="">
	<meta name="description" conDeluxe Room="">
    <meta name="viewport" conDeluxe Room="width=device-width, initial-scale=1.0, user-scalable=no">
	<meta http-equiv="ConDeluxe Room-Type" conDeluxe Room="text/html; charset=utf-8">
  ...
  <div id="wrap">
				...
				<div class="col-md-12">
					<div class="detail">
						...
						<ul>
							...
							<li><a class="select">Deluxe Room</a></li>
						</ul>
					</div>
				</div>
			</div>
   ...
   <!--Start ConDeluxe Room-->
	<div class="conDeluxe Room">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div id="hotel-view" class="owl-carousel owl-theme">
								<div class="item"><img src="imgs/rooms/deluxe-1.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/deluxe-2.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/deluxe-3.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/deluxe-4.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/deluxe-5.jpg" alt=""></div>
