<!DOCTYPE html>
<html><head>
    <title>Family Rooms | Amadi Beach Front Resort</title>
    <meta name="keywords" conFamily Rooms="">
	<meta name="description" conFamily Rooms="">
    <meta name="viewport" conFamily Rooms="width=device-width, initial-scale=1.0, user-scalable=no">
	<meta http-equiv="ConFamily Rooms-Type" conFamily Rooms="text/html; charset=utf-8">
  ...
  <div id="wrap">
				...
				<div class="col-md-12">
					<div class="detail">
						...
						<ul>
							...
							<li><a class="select">Family Rooms</a></li>
						</ul>
					</div>
				</div>
			</div>
   ...
   <!--Start ConFamily Rooms-->
	<div class="conFamily Rooms">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div id="hotel-view" class="owl-carousel owl-theme">
								<div class="item"><img src="imgs/rooms/family-1.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/family-2.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/family-3.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/family-4.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/family-5.jpg" alt=""></div>
