<!DOCTYPE html>
<html><head>
    <title>Superior Room | Amadi Beach Front Resort</title>
    <meta name="keywords" conSuperior Room="">
	<meta name="description" conSuperior Room="">
    <meta name="viewport" conSuperior Room="width=device-width, initial-scale=1.0, user-scalable=no">
	<meta http-equiv="ConSuperior Room-Type" conSuperior Room="text/html; charset=utf-8">
  ...
  <div id="wrap">
				...
				<div class="col-md-12">
					<div class="detail">
						...
						<ul>
							...
							<li><a class="select">Superior Room</a></li>
						</ul>
					</div>
				</div>
			</div>
   ...
   <!--Start ConSuperior Room-->
	<div class="conSuperior Room">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div id="hotel-view" class="owl-carousel owl-theme">
								<div class="item"><img src="imgs/rooms/superior-1.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/superior-2.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/superior-3.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/superior-4.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/superior-5.jpg" alt=""></div>
