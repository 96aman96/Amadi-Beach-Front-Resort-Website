<!DOCTYPE html>
<html><head>
    <title>Sea View Room | Amadi Beach Front Resort</title>
    <meta name="keywords" conSea View Room="">
	<meta name="description" conSea View Room="">
    <meta name="viewport" conSea View Room="width=device-width, initial-scale=1.0, user-scalable=no">
	<meta http-equiv="ConSea View Room-Type" conSea View Room="text/html; charset=utf-8">
  ...
  <div id="wrap">
				...
				<div class="col-md-12">
					<div class="detail">
						...
						<ul>
							...
							<li><a class="select">Sea View Room</a></li>
						</ul>
					</div>
				</div>
			</div>
   ...
   <!--Start ConSea View Room-->
	<div class="conSea View Room">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div id="hotel-view" class="owl-carousel owl-theme">
								<div class="item"><img src="imgs/rooms/sea-1.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/sea-2.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/sea-3.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/sea-4.jpg" alt=""></div>
								<div class="item"><img src="imgs/rooms/sea-5.jpg" alt=""></div>
